# Val Gold Court Citations — Mental-Model Tree Schemas (v2 — Zero Unclassified)

_For each gold court citation, this section shows the FULL tree of the case it belongs to. Every paragraph is now classified — no "unclassified" residue._

## Legend (v2 — extended)

- 📜 **RULE** — Court rule statement (canonical doctrine)
- 🔁 **echo-cite** — Echoes precedent (mostly BGE citation chain)
- 🤔 **reasoning** — General court analytical reasoning (no specific role)
...
## Role distribution across the 379 paragraphs in the 27 sampled cases
